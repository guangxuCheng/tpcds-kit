...
-- ============================================================
drop table if exists s_catalog_page_2;
create table s_catalog_page_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_catalog_page'
;
...
--   Table: s_zip_to_gmt                                       
-- ============================================================
drop table if exists s_zip_to_gmt_2;
create table s_zip_to_gmt_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_zip_to_gmt'
;
...
-- ============================================================
drop table if exists s_purchase_lineitem_2;
create table s_purchase_lineitem_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_purchase_lineitem'
;
...
--   Table: s_customer                                         
-- ============================================================
drop table if exists s_customer_2;
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_customer'
;
...
-- ============================================================
drop table if exists s_customer_address_2;
create table s_customer_address_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_customer_address'
;
...
--   Table: s_purchase                                         
-- ============================================================
drop table if exists s_purchase_2;
create table s_purchase_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_purchase'
;
...
-- ============================================================
drop table if exists s_catalog_order_2;
create table s_catalog_order_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_catalog_order'
;
...
--   Table: s_web_order                                        
-- ============================================================
drop table if exists s_web_order_2;
create table s_web_order_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_web_order'
;
...
--   Table: s_item                                             
-- ============================================================
drop table if exists s_item_2;
create table s_item_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_item'
;
...
-- ============================================================
drop table if exists s_catalog_order_lineitem_2;
create table s_catalog_order_lineitem_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_catalog_order_lineitem'
;
...
-- ============================================================
drop table if exists s_web_order_lineitem_2;
create table s_web_order_lineitem_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_web_order_lineitem'
;
...
--   Table: s_store                                            
-- ============================================================
drop table if exists s_store_2;
create table s_store_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_store'
;
...
--   Table: s_call_center                                      
-- ============================================================
drop table if exists s_call_center_2;
create table s_call_center_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_call_center'
;
...
--   Table: s_web_site                                         
-- ============================================================
drop table if exists s_web_site_2;
create table s_web_site_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_web_site'
;
...
--   Table: s_warehouse                                        
-- ============================================================
drop table if exists s_warehouse_2;
create table s_warehouse_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_warehouse'
;
...
--   Table: s_web_page                                         
-- ============================================================
drop table if exists s_web_page_2;
create table s_web_page_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_web_page'
;
...
--   Table: s_promotion                                        
-- ============================================================
drop table if exists s_promotion_2;
create table s_promotion_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_promotion'
;
...
-- ============================================================
drop table if exists s_store_returns_2;
create table s_store_returns_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_store_returns'
;
...
-- ============================================================
drop table if exists s_catalog_returns_2;
create table s_catalog_returns_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_catalog_returns'
;
...
--   Table: s_web_returns                                      
-- ============================================================
drop table if exists s_web_returns_2;
create table s_web_returns_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_web_returns'
;
...
--   Table: s_inventory                                        
-- ============================================================
drop table if exists s_inventory_2;
create table s_inventory_2
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/2/s_inventory'
;