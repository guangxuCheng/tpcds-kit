...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_catalog_page"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_zip_to_gmt"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_purchase_lineitem"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_customer"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_customer_address"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_purchase"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_catalog_order"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_web_order"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_item"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_catalog_order_lineitem"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_web_order_lineitem"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_store"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_call_center"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_web_site"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_warehouse"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_web_page"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_promotion"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_store_returns"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_catalog_returns"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_web_returns"
}';
...
engine='localfile'
TABLE_PROPERTIES='{
    "dir":"${worker_mt_data_docker_path}/mt_${ROUND}/s_inventory"
}';
