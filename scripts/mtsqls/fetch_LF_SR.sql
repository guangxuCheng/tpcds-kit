...
,cast(sret_return_amt + sret_return_tax as decimal(7,2)) sr_return_amt_inc_tax
...
,cast(sret_return_amt+sret_return_tax+sret_return_fee
-sret_refunded_cash-sret_reversed_charge-sret_store_credit as decimal(7,2)) sr_net_loss
