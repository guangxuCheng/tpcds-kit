...
,cast(wret_return_amt + wret_return_tax as decimal(7,2)) AS wr_return_amt_inc_tax
...
,cast(wret_return_amt+wret_return_tax+wret_return_fee
-wret_refunded_cash-wret_reversed_charge-wret_account_credit as decimal(7,2)) wr_net_loss
