...
,cast( cret_return_amt + cret_return_tax as decimal(7,2)) as cr_return_amt_inc_tax
...
,cast(cret_return_amt + cret_return_tax + cret_return_fee - cret_refunded_cash - cret_reversed_charge - cret_merchant_credit as decimal(7,2)) cr_net_loss
