...
-- ============================================================
drop table if exists s_catalog_page_4;
create table s_catalog_page_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_catalog_page'
;
...
--   Table: s_zip_to_gmt                                       
-- ============================================================
drop table if exists s_zip_to_gmt_4;
create table s_zip_to_gmt_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_zip_to_gmt'
;
...
-- ============================================================
drop table if exists s_purchase_lineitem_4;
create table s_purchase_lineitem_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_purchase_lineitem'
;
...
--   Table: s_customer                                         
-- ============================================================
drop table if exists s_customer_4;
create table s_customer_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_customer'
;
...
-- ============================================================
drop table if exists s_customer_address_4;
create table s_customer_address_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_customer_address'
;
...
--   Table: s_purchase                                         
-- ============================================================
drop table if exists s_purchase_4;
create table s_purchase_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_purchase'
;
...
-- ============================================================
drop table if exists s_catalog_order_4;
create table s_catalog_order_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_catalog_order'
;
...
--   Table: s_web_order                                        
-- ============================================================
drop table if exists s_web_order_4;
create table s_web_order_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_web_order'
;
...
--   Table: s_item                                             
-- ============================================================
drop table if exists s_item_4;
create table s_item_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_item'
;
...
-- ============================================================
drop table if exists s_catalog_order_lineitem_4;
create table s_catalog_order_lineitem_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_catalog_order_lineitem'
;
...
-- ============================================================
drop table if exists s_web_order_lineitem_4;
create table s_web_order_lineitem_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_web_order_lineitem'
;
...
--   Table: s_store                                            
-- ============================================================
drop table if exists s_store_4;
create table s_store_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_store'
;
...
--   Table: s_call_center                                      
-- ============================================================
drop table if exists s_call_center_4;
create table s_call_center_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_call_center'
;
...
--   Table: s_web_site                                         
-- ============================================================
drop table if exists s_web_site_4;
create table s_web_site_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_web_site'
;
...
--   Table: s_warehouse                                        
-- ============================================================
drop table if exists s_warehouse_4;
create table s_warehouse_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_warehouse'
;
...
--   Table: s_web_page                                         
-- ============================================================
drop table if exists s_web_page_4;
create table s_web_page_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_web_page'
;
...
--   Table: s_promotion                                        
-- ============================================================
drop table if exists s_promotion_4;
create table s_promotion_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_promotion'
;
...
-- ============================================================
drop table if exists s_store_returns_4;
create table s_store_returns_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_store_returns'
;
...
-- ============================================================
drop table if exists s_catalog_returns_4;
create table s_catalog_returns_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_catalog_returns'
;
...
--   Table: s_web_returns                                      
-- ============================================================
drop table if exists s_web_returns_4;
create table s_web_returns_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_web_returns'
;
...
--   Table: s_inventory                                        
-- ============================================================
drop table if exists s_inventory_4;
create table s_inventory_4
(
...
location 'dbfs:/mnt/aws-tpcds-audit//tpcds_100000_maintenance_files_audit/4/s_inventory'
;