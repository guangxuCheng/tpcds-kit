...
cast((i_current_price-plin_sale_price)*plin_quantity as decimal(7,2)) ss_ext_discount_amt,
cast(plin_sale_price * plin_quantity as decimal(7,2)) ss_ext_sales_price,
cast(i_wholesale_cost * plin_quantity as decimal(7,2)) ss_ext_wholesale_cost,
cast(i_current_price * plin_quantity as decimal(7,2)) ss_ext_list_price,
cast(i_current_price * s_tax_percentage as decimal(7,2)) ss_ext_tax,
plin_coupon_amt ss_coupon_amt,
cast((plin_sale_price * plin_quantity)-plin_coupon_amt as decimal(7,2)) ss_net_paid,
cast(((plin_sale_price * plin_quantity)-plin_coupon_amt)*(1+s_tax_percentage) as decimal(7,2)) ss_net_paid_inc_tax,
cast(((plin_sale_price * plin_quantity)-plin_coupon_amt)-(plin_quantity*i_wholesale_cost) as decimal(7,2))
ss_net_profit
FROM
s_purchase_${ROUND}
