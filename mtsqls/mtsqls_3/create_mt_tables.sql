...
-- ============================================================
drop table if exists s_catalog_page_3;
create table s_catalog_page_3
(
...
location 'DBFS_MT_FILES/3/s_catalog_page*.dat'
;
...
--   Table: s_zip_to_gmt                                       
-- ============================================================
drop table if exists s_zip_to_gmt_3;
create table s_zip_to_gmt_3
(
...
location 'DBFS_MT_FILES/3/s_zip_to_gmt*.dat'
;
...
-- ============================================================
drop table if exists s_purchase_lineitem_3;
create table s_purchase_lineitem_3
(
...
location 'DBFS_MT_FILES/3/s_purchase_lineitem*.dat'
;
...
--   Table: s_customer                                         
-- ============================================================
drop table if exists s_customer_3;
create table s_customer_3
(
...
location 'DBFS_MT_FILES/3/s_customer*.dat'
;
...
-- ============================================================
drop table if exists s_customer_address_3;
create table s_customer_address_3
(
...
location 'DBFS_MT_FILES/3/s_customer_address*.dat'
;
...
--   Table: s_purchase                                         
-- ============================================================
drop table if exists s_purchase_3;
create table s_purchase_3
(
...
location 'DBFS_MT_FILES/3/s_purchase*.dat'
;
...
-- ============================================================
drop table if exists s_catalog_order_3;
create table s_catalog_order_3
(
...
location 'DBFS_MT_FILES/3/s_catalog_order*.dat'
;
...
--   Table: s_web_order                                        
-- ============================================================
drop table if exists s_web_order_3;
create table s_web_order_3
(
...
location 'DBFS_MT_FILES/3/s_web_order*.dat'
;
...
--   Table: s_item                                             
-- ============================================================
drop table if exists s_item_3;
create table s_item_3
(
...
location 'DBFS_MT_FILES/3/s_item*.dat'
;
...
-- ============================================================
drop table if exists s_catalog_order_lineitem_3;
create table s_catalog_order_lineitem_3
(
...
location 'DBFS_MT_FILES/3/s_catalog_order_lineitem*.dat'
;
...
-- ============================================================
drop table if exists s_web_order_lineitem_3;
create table s_web_order_lineitem_3
(
...
location 'DBFS_MT_FILES/3/s_web_order_lineitem*.dat'
;
...
--   Table: s_store                                            
-- ============================================================
drop table if exists s_store_3;
create table s_store_3
(
...
location 'DBFS_MT_FILES/3/s_store*.dat'
;
...
--   Table: s_call_center                                      
-- ============================================================
drop table if exists s_call_center_3;
create table s_call_center_3
(
...
location 'DBFS_MT_FILES/3/s_call_center*.dat'
;
...
--   Table: s_web_site                                         
-- ============================================================
drop table if exists s_web_site_3;
create table s_web_site_3
(
...
location 'DBFS_MT_FILES/3/s_web_site*.dat'
;
...
--   Table: s_warehouse                                        
-- ============================================================
drop table if exists s_warehouse_3;
create table s_warehouse_3
(
...
location 'DBFS_MT_FILES/3/s_warehouse*.dat'
;
...
--   Table: s_web_page                                         
-- ============================================================
drop table if exists s_web_page_3;
create table s_web_page_3
(
...
location 'DBFS_MT_FILES/3/s_web_page*.dat'
;
...
--   Table: s_promotion                                        
-- ============================================================
drop table if exists s_promotion_3;
create table s_promotion_3
(
...
location 'DBFS_MT_FILES/3/s_promotion*.dat'
;
...
-- ============================================================
drop table if exists s_store_returns_3;
create table s_store_returns_3
(
...
location 'DBFS_MT_FILES/3/s_store_returns*.dat'
;
...
-- ============================================================
drop table if exists s_catalog_returns_3;
create table s_catalog_returns_3
(
...
location 'DBFS_MT_FILES/3/s_catalog_returns*.dat'
;
...
--   Table: s_web_returns                                      
-- ============================================================
drop table if exists s_web_returns_3;
create table s_web_returns_3
(
...
location 'DBFS_MT_FILES/3/s_web_returns*.dat'
;
...
--   Table: s_inventory                                        
-- ============================================================
drop table if exists s_inventory_3;
create table s_inventory_3
(
...
location 'DBFS_MT_FILES/3/s_inventory*.dat'
;